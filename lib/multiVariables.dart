...
class MultiVariables extends StatefulWidget {
  List myvariables;
  MultiVariables({this.myvariables});
  @override
  _MultiVariablesState createState() => _MultiVariablesState();
}

class _MultiVariablesState extends State<MultiVariables> {
